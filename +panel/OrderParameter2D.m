...
uicontrol(p, 'Style', 'text', 'HorizontalAlignment', 'left', ...
    'String', ['y = a ' char(215) ' S_align + (1 - a) ' char(215) ' S_rand'], ...
    'Position', [10 ph-38 200 14]);
uicontrol(p, 'Style', 'text', 'HorizontalAlignment', 'left', ...
    'String', ['S_align = b + (1 - b) ' char(215) ' exp[ -x / (2L) ]'], ...
    'Position', [10 ph-55 200 14]);
% Processing area
uicontrol(p, 'Style', 'text', 'HorizontalAlignment', 'left', ...
