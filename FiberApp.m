...
% ------------------------------
stackImageItem = uimenu(imageMenu, 'Label', 'Image Stack', 'Separator', 'on');
uimenu(stackImageItem, 'Label', 'Next Image', ...
    'Callback', @(hObj, event, dir) FiberAppGUI.ImageStack(hObj, event, 'next'));
uimenu(stackImageItem, 'Label', 'Prev Image', ...
    'Callback', @(hObj, event, dir) FiberAppGUI.ImageStack(hObj, event, 'prev'));
% ------------------------------
